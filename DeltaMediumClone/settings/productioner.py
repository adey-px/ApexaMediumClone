...
# Admin email for login, get code error notification
# Receives emails on exceptions raised in req & res cycle
ADMINS = [("Oreofe Stephen", "aosteph@gmail.com")]

# Domain name of production server
